...
const mapStateToProps = (state: State): StateProps => ({
  ...
  description: t`Allows users with existing CloudVision accounts to login with a Google account that matches their email address in addition to their CloudVision username and password.`,
