              ...
              <Accordion.Panel>
                <Stack spacing="lg">
                  ...
                  {!isPaidPlan ? (
                    ...
                    <Text>{t`Don't be shy with invites. CloudVision makes self-service analytics easy.`}</Text>
                  ) : (
                    // eslint-disable-next-line no-literal-metabase-strings -- This string only shows for admins
                    <Text>{t`Don't be shy with invites. CloudVision Starter plan includes 5 users, and Pro includes 10 users without the need to pay additionally.`}</Text>
                  )}
