      ...
      <Stack align="center" spacing="3rem">
        ...
        <LegaleseStepDetailsContainer p="lg" w="40rem">
          ...
          <Text>
            ...
            {t`When you embed charts or dashboards from CloudVision in your own application that application isn't subject to the Affero General Public License that covers the rest of CloudVision, provided you keep the CloudVision logo and the "Powered by CloudVision" visible on those embeds.`}
          </Text>
          <Text>
